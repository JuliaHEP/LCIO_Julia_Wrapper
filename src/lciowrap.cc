...
JLCXX_MODULE define_julia_module(jlcxx::Module& lciowrap)
{
    ...
    lciowrap.add_type<LCRunHeader>("LCRunHeader")
        ...
        .method("getDetectorName_cxx", &LCRunHeader::getDetectorName)
        .method("getDescription_cxx", &LCRunHeader::getDescription)
    ...
    lciowrap.add_type<LCEvent>("LCEvent")
        ...
        .method("getDetectorName_cxx", &LCEvent::getDetectorName)
